...
namespace FiyiStackApp.Generation.NET6CleanArchitecture.Modules
{
    ...
    {
        public static string RemoveTableResponse(GeneratorConfigurationComponent GeneratorConfigurationComponent, Table Table)
        {
            try
            {
                string Content =
...
public class Remove{Table.Name}Response
{{
