...
WHERE
    1=1
    AND (@QueryString = '' 
        {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.SQLServerFieldsForWhereClauseSelectAllPaged_ForSQLServer.TrimEnd(' ')}
    )
ORDER BY {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.SQLServerFieldsForSelectAllPaged_ForSQLServer}
";
                Query = Query.TrimEnd('\n', '\r', ',');
