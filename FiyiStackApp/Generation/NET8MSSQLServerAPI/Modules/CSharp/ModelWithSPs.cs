...
{{
    ...
    /// Fields:            {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.NumberOfFields} <br/> 
    /// Sub-models:      {GeneratorConfigurationComponent.modelChainerNET8MSSQLServerAPI.CounterOfModelsThatDependOnThis} models <br/>
    ...
    {{
        ...
        #region Fields
        {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFields_ForCSharpModel}
        #endregion

        #region Sub-lists
        {GeneratorConfigurationComponent.modelChainerNET8MSSQLServerAPI.CSharpModelsThatDependOnThis_ForCSharpModel}
        #endregion
        ...
        /// Fields:       {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.NumberOfFields} <br/> 
        /// Dependencies: {GeneratorConfigurationComponent.modelChainerNET8MSSQLServerAPI.CounterOfModelsThatDependOnThis} models depend on this model <br/>
        /// </summary>
        ...
        {{
            ...
            {{
                ...
                {GeneratorConfigurationComponent.modelChainerNET8MSSQLServerAPI.NewList_ForCSharpModel}
            }}
        ...
        {{
            ...
            {{
                ...
                {{
                    {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsAndParameters1_ForCSharpModel.Replace("\t\t\t\t", "\t\t\t\t\t")}
                }}
            }}
            catch (Exception ex) {{ throw ex; }}
        }}
        ...
        /// Dependencies: {GeneratorConfigurationComponent.modelChainerNET8MSSQLServerAPI.CounterOfModelsThatDependOnThis} models depend on this model <br/>
        /// </summary>
        public {Table.Name}Model({GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsAsParametersInOneLine_ForCSharpModel})
        {{
            try
            {{
                //Initialize sub-lists
                ...
                {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsAndParameters2_ForCSharpModel}
            }}
            catch (Exception ex) {{ throw ex; }}
        }}
        ...
        {{
            ...
            {{
                ...
                {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsAndParameters1_ForCSharpModel.Replace("this.", "")}
            }}
            catch (Exception ex) {{ throw ex; }}
        }}
        #endregion
        ...
        {{
            ...
            {{
                ...
                foreach ({Table.Name}Model {Table.Name.ToLower()} in lst{Table.Name}Model)
                {{
                    {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsAndParameters4_ForCSharpModel}
                }}
        ...
        {{
            ...
            {{
                ...
                {GeneratorConfigurationComponent.modelChainerNET8MSSQLServerAPI.LoopThroughListsAndSubLists_ForCSharpModel}
        ...
        {{
            ...
            {{
                ...
                {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsForNonQuerySP1_ForCSharpModel.Replace($@"dp.Add(""{Table.Name}Id"", {Table.Name}Id, DbType.Int32, ParameterDirection.Input);
" + "\t\t\t\t", "")}
        ...
        {{
            ...
            {{
                ...
                {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsForNonQuerySP2_ForCSharpModel.Replace($@"dp.Add(""{Table.Name}Id"", {Table.Name.ToLower()}.{Table.Name}Id, DbType.Int32, ParameterDirection.Input);
" + "\t\t\t\t", "")}
                dp.Add(""NewEnteredId"", NewEnteredId, DbType.Int32, ParameterDirection.Output);
        ...
        /// </summary>
        /// <returns>The ID of the last registry inserted in {Table.Name} table</returns>
        public int Insert({GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsAsParametersInOneLine_ForCSharpModel.Replace($"int {Table.Name}Id, ", "")})
        {{
            try
            {{
                int NewEnteredId = 0;
...
" + "\t\t\t\t", "")}
        ...
        {{
            ...
            {{
                ...
                {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsForNonQuerySP1_ForCSharpModel}
        ...
        {{
            ...
            {{
                ...
                {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsForNonQuerySP2_ForCSharpModel}
                dp.Add(""RowsAffected"", RowsAffected, DbType.Int32, ParameterDirection.Output);
        ...
        /// </summary>
        /// <returns>The number of rows updated in {Table.Name} table</returns>
        public int UpdateBy{Table.Name}Id({GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsAsParametersInOneLine_ForCSharpModel})
        {{
            try
            {{
                int RowsAffected = 0;
        ...
        {{
            return {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsForToStringFunction_ForCSharpModel};
        }}

        public string ToStringOnlyValuesForHTML()
        {{
            return $@""<tr>
                {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.CSharpFieldsForToStringOnlyValuesForHTMLFunction_ForCSharpModel}
                </tr>"";
        }}
    }}
}}";
