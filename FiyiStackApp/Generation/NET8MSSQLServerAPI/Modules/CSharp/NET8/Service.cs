...
<table cellpadding=""""0"""" cellspacing=""""0"""" border=""""0"""" width=""""100%"""" style=""""width: 100% !important; min-width: 100%; max-width: 100%;"""">
    <tr>
        {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.Fields_ForIronPDF_Converter}
    </tr>
    {{RowsAsHTML}}
</table>
<br>
...
"").SaveAs($@""wwwroot/PDFFiles/{Table.Area}/{Table.Name}/{Table.Name}_{{Now.ToString(""yyyy_MM_dd_HH_mm_ss_fff"")}}.pdf"");
        ...
        {{
            ...
            {{
                ...
                {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.Fields_ForExcel_Converter_DefineDataColumns.TrimEnd('\t')}
                #endregion
            ...
            {{
                ...
                {{
                    ...
                    #region Define columns for dt{Table.Name}Copy
                    {GeneratorConfigurationComponent.fieldChainerNET8MSSQLServerAPI.Fields_ForExcel_Converter_DefineDataColumns}
                    #endregion
