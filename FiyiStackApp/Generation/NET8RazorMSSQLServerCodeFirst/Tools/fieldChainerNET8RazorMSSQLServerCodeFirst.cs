...
{
    public class fieldChainerNET8RazorMSSQLServerCodeFirst
    {
        ...
        public fieldChainerNET8RazorMSSQLServerCodeFirst()
        {
        }
        ...
        ///</summary>
        public fieldChainerNET8RazorMSSQLServerCodeFirst(Table Table)
        {
            Field Field = new();
