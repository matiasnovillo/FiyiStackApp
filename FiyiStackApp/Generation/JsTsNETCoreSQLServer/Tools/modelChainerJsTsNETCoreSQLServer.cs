...
{
    public class modelChainerJsTsNETCoreSQLServer
    {
        ...
        public modelChainerJsTsNETCoreSQLServer()
        {
        }
        /// <summary>
        ...
        public modelChainerJsTsNETCoreSQLServer(Table Blog, List<Table> lstAllTables)
        {
