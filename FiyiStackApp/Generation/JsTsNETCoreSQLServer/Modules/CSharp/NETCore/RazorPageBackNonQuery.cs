...
namespace FiyiStackApp.Generation.JsTsNETCoreSQLServer.Modules
{
    ...
    {
        public static string RazorPageBackNonQuery(GeneratorConfigurationComponent GeneratorConfigurationComponent, Table Table)
        {
            try
            {
                string Content =
...
{{
    ...
    /// </summary>
    [{Table.Name}Filter]
    public partial class {Table.Name}NonQueryPageModel : PageModel
    {{
        public void OnGet()
        {{
